    ...
    DWORD dwFlags)
{
    ...
    while (*strText) {
        ...
        if (c != _T(' ')) {
            ...
            *pVertices++ = InitFont2DVertex(XMFLOAT4(sx + 0 - 0.5f, sy + h - 0.5f, 1.0f, 1.0f), dwColor, tx1, ty2);
            *pVertices++ = InitFont2DVertex(XMFLOAT4(sx + 0 - 0.5f, sy + 0 - 0.5f, 1.0f, 1.0f), dwColor, tx1, ty1);
            *pVertices++ = InitFont2DVertex(XMFLOAT4(sx + w - 0.5f, sy + h - 0.5f, 1.0f, 1.0f), dwColor, tx2, ty2);
            *pVertices++ = InitFont2DVertex(XMFLOAT4(sx + w - 0.5f, sy + 0 - 0.5f, 1.0f, 1.0f), dwColor, tx2, ty1);
            *pVertices++ = InitFont2DVertex(XMFLOAT4(sx + w - 0.5f, sy + h - 0.5f, 1.0f, 1.0f), dwColor, tx2, ty2);
            *pVertices++ = InitFont2DVertex(XMFLOAT4(sx + 0 - 0.5f, sy + 0 - 0.5f, 1.0f, 1.0f), dwColor, tx1, ty1);
            dwNumTriangles += 2;
